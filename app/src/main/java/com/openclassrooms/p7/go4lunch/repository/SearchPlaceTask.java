...
public class SearchPlaceTask extends AsyncTask<String, Integer, List<String>> {
    ...
    protected List<String> doInBackground(String... strings) {
        ...
        try {
            ...
            listOfId = jsonParser.parsePredictions(object);
    ...
    protected void onPostExecute(List<String> listOfId) {
        getListOfPlaceId().postValue(listOfId);
    }
}
